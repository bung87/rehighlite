...
const explicitSourcePath {.strdefine.} = os.getCurrentCompilerExe().parentDir.parentDir
...
mImport(explicitSourcePath / "compiler" / "idents.nim")
mImport(explicitSourcePath / "compiler" / "ast.nim")
mImport(explicitSourcePath / "compiler" / "lineinfos.nim")
mImport(explicitSourcePath / "compiler" / "renderer.nim")
...
func toNNK*(kind: TNodeKind): NimNodeKind = cast[NimNodeKind](kind)
